...
export default function nDashboard() {
    ...
    const fetchUserPosts = async (token) => {
        try {
            const response = await axios.get("https://mern-blog-vz8i.onrender.com/api/posts/user/posts", {
            ...
            <div className="flex flex-col items-center justify-center ">
                <div className="bg-white p-8 rounded-lg shadow md:w-full w-96 ">
                    ...
                    {posts.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3  lg:flex lg:justify-cente items-centerr flex-wrap   gap-4  flex-wrap gap-6 mt-6">
                            {posts.map(post => (
